...
export const GrowthIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 18 9-9 4.5 4.5L21 6" />
...
export const CommunityIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962A3.75 3.75 0 0 1 12 15.75c1.255 0 2.42.49 3.292 1.359m-3.292-1.359a3.752 3.752 0 0 1-3.292-1.359m6.584 0a3.752 3.752 0 0 0-3.292-1.359m0 0A3.752 3.752 0 0 1 6.708 15.75m0 0a3.75 3.75 0 0 1 2.23-3.292m3.292 1.359 3.292-1.359m0 0a3.75 3.75 0 0 1-3.292-1.359m0 0l-3.292-1.359m0 0v-3.375c0-1.621 1.323-2.936 2.946-2.936l.294 0a2.946 2.946 0 0 1 2.946 2.936v3.375m-6.584 0-3.292-1.359m0 0a3.75 3.75 0 0 0-3.292 1.359" />
    </svg>
);
